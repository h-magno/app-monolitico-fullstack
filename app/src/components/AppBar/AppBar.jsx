    ...
    <AppBar 
      ...
      <Container maxWidth="xl" >
        <Toolbar disableGutters >
          ...
          >
            <img width='60px' alt="Logo" src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/TK_archive_icon.svg/1024px-TK_archive_icon.svg.png" ></img>
          </Typography>
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            {pages.map((page) => (
              ...
              >
                <Link className='nav-buttons' style={{color: 'white', textDecoration: 'none'}} to={page.link}>
                    {page.name}
                </Link>
              </Button>
            ))}
